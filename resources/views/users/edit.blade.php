...
@section('title', $user->name . ' সংশোধন')
                    ...
                    <div class="col-lg-4">
                        <div class="mb-8 fv-row">
                            ...
                            <input type="text" name="name" class="form-control form-control-solid fs-4"
                                placeholder="ইউজারের নাম লিখুন" value="{{ $user->name }}">
                        </div>
                    </div>
                            ...
                            <select name="designation_id" class="form-select form-select-solid fs-4" data-control="select2"
                                ...
                                @foreach ($designations as $designation)
                                    <option value="{{ $designation->id }}"
                                        @if ($designation->id == $user->designation_id) selected @endif>
                                        {{ $designation->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-8 fv-row">
                            ...
                            <input type="email" name="email" class="form-control form-control-solid fs-4"
                                placeholder="ইমেইল এড্রেস লিখুন" required value="{{ $user->email }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-8 fv-row">
                            ...
                            <input type="number" name="mobile_no" class="form-control form-control-solid fs-4"
                                placeholder="মোবাইল নাম্বার লিখুন" required value="{{ $user->mobile_no }}">
                        </div>
                    </div>
...
@push('page-js')
    <script>
        const editUserRoute = "{{ route('users.update', ':id') }}";
    </script>
