...
<style>
    ...
    .ranking-2 { background: linear-gradient(135deg, #C0C0C0, #A0A0A0); color: white; }
    .ranking-3 { background: linear-gradient(135deg, #CD7F32, #8B4513); color: white; }
...
@section('content')
            ...
            <div class="card h-100">
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex align-items-center">
                            <button type="button" class="btn btn-sm btn-icon btn-light me-2 month-nav-btn" id="prevMonthBtn">
                                <i class="ki-outline ki-left fs-2"></i>
                            </button>
                            <span class="fw-bold text-gray-800 fs-5 mx-2" id="currentMonthLabel">লোড হচ্ছে...</span>
                            <button type="button" class="btn btn-sm btn-icon btn-light ms-2 month-nav-btn" id="nextMonthBtn">
    ...
    <!-- Zone/Union & User Tables -->
    <div class="row g-5 g-xl-8 mb-5 mb-xl-8">
        <!-- Zone & Union wise Report Count with Tabs -->
        <div class="col-xl-6">
            <div class="card h-100">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">এলাকা অনুযায়ী রিপোর্ট</span>
                        <span class="text-muted fw-semibold fs-7">জোন ও ইউনিয়ন ভিত্তিক রিপোর্ট</span>
                    </h3>
                    <div class="card-toolbar">
                        <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" href="#zoneTab" role="tab">
                                    <i class="ki-outline ki-geolocation fs-4 me-1"></i>
                                    জোন
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#unionTab" role="tab">
                                    <i class="ki-outline ki-map fs-4 me-1"></i>
                                    ইউনিয়ন
                                </a>
                            </li>
                        </ul>
                ...
                <div class="card-body py-3">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="zoneTab" role="tabpanel">
                            <div class="table-responsive scroll-y">
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    <thead>
                                        <tr class="fw-bold text-muted">
                                            <th class="min-w-150px ps-4">জোন</th>
                        ...
                        <!-- Union Tab -->
                        <div class="tab-pane fade" id="unionTab" role="tabpanel">
                            <div class="table-responsive scroll-y">
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    <thead>
                                        <tr class="fw-bold text-muted">
            ...
            <div class="card h-100">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted fw-semibold fs-7">শীর্ষ ব্যবহারকারীদের তালিকা</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                    <div class="table-responsive scroll-y">
    ...
    <div class="row g-5 g-xl-8 mb-5 mb-xl-8">
        ...
        <div class="col-xl-6">
            <div class="card h-100">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">জোন ভিত্তিক রিপোর্ট চার্ট</span>
                        <span class="text-muted fw-semibold fs-7">জোন অনুযায়ী তুলনামূলক চিত্র</span>
                    </h3>
                </div>
                <div class="card-body">
                    <div id="zoneBarChart" class="chart-container"></div>
                </div>
            </div>
        </div>
    </div>

    <!-- Candidate & Recent Reports -->
            ...
            <div class="card h-100">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted fw-semibold fs-7">সর্বশেষ জমাকৃত রিপোর্ট</span>
                    </h3>
                    <div class="card-toolbar">
                        <a href="{{ route('reports.index') }}" class="btn btn-sm btn-primary">
                            সব দেখুন
                            <i class="ki-outline ki-arrow-right fs-4 ms-1">
                ...
                <div class="card-body py-3">
                    <div class="scroll-y" id="recentReports">
                        <!-- Dynamic content from JS -->
                    </div>
                </div>
            </div>
