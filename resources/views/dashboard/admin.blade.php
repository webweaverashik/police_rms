                                ...
                                <div class="me-md-5 w-100">
                                        ...
                                        <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                            ...
                                            <div class="symbol symbol-50px me-4">
                                                <span class="symbol-label">
                                                    <i class="ki-outline ki-timer fs-2qx text-primary">
                                    ...
                                    <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                        ...
                                        <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                            ...
                                            <div class="symbol symbol-50px me-4">
                                                <span class="symbol-label">
                                                    <i class="ki-outline ki-abstract-24 fs-2qx text-primary">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active show">
                            ...
                            <!--end::Statistics-->
                            <!--begin::Chart-->
                            <div id="kt_sliders_widget_3_chart_1" class="min-h-auto ps-4 pe-6" style="height: 330px">
                            </div>
                            <!--end::Chart-->
                        </div>
                        <!--end::Item-->
                        ...
                        <div class="carousel-item">
                            ...
                            <!--end::Statistics-->
                            <!--begin::Chart-->
                            <div id="kt_sliders_widget_3_chart_2" class="min-h-auto ps-4 pe-6" style="height: 330px">
                            </div>
                            <!--end::Chart-->
                        </div>
                        <!--end::Item-->
                                ...
                                <table class="table align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary fw-bold fs-6">Book p. 77-85,
                                                    read & complete tasks 1-6 on p. 85</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary fw-bold fs-6">Workbook p. 17,
                                                    tasks 1-6</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary fw-bold fs-6">Learn paragraph
                                                    p. 99, Exercise 1,2,3Scoping & Estimations</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary fw-bold fs-6">Write essay 1000
                                                    words “WW2 results”</a>
